...
import Item_img from "@/midias/Items/pedras.png";
...
async function Page() {
  ...
  return (
    <section className="px-32">
      <main>
        <WitcherHead
          title="Buy Diablo 4 Items"
          description="D4Gold.com is the best Diablo 4 Items selling store, offering affordable materials, uniques, legendary and more. Buy D4 Items Season/Eternal - Softcore/Hardcore with easy process, safe payment and fast delivery."
        />
      </main>
